...
package body Tubastga_Game.Carrier is
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Game.Carrier.Get_Tower_Code - enter " & P_Tower_Id1'Img & "-" & P_Tower_Id2'Img & "-" & P_Tower_Id3'Img & "-");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Game.Carrier.Get_Tower_Code - exit Tmp=" & Tmp);
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Game.Carrier.Get_Tower_Id - enter P_Tower_Code=" & P_Tower_Code'Img);
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Game.Carrier.Get_Tower_Id - enter Ret=" & Ret'Img);
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Game.Carrier.Get_Tower_Goods_Code - enter P_Goods_Id1=" & P_Goods_Id1'Img & " P_Goods_Id2=" & P_Goods_Id2'Img & " P_Goods_Id3=" & P_Goods_Id3'Img);
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Game.Carrier.Get_Tower_Goods_Code - enter Tmp=" & Tmp);
      end if;
      return Integer'Value (Tmp);
