...
package body Tubastga_Window_Pkg is
   ...
   begin
      ...
      Tubastga_Window_Pkg.Gtk_New (P_Wnd_Main.all.Wnd_Action);
      Tubastga_Window_Pkg.Show_All (P_Wnd_Main.all.Wnd_Action);
   ...
   procedure Gtk_New (P_Wnd_Action : out Type_Wnd_Action_Access) is
   begin
      P_Wnd_Action := new Type_Wnd_Action_Record;
      Tubastga_Window_Pkg.Initialize (P_Wnd_Action);
   end Gtk_New;

   --Performing_Pieces_Scroll_VBox
   procedure Initialize_Performing_Pieces_Scroll_VBox
   ...
   begin
      ...
      Gtk.Tree_View.Gtk_New
        (P_Wnd_Action.all.Performing_Pieces_Tree_View, P_Wnd_Action.all.Performing_Pieces_List_Store);

      Gtk.Tree_View_Column.Gtk_New (Col_Piece_Image);
      Gtk.Tree_View_Column.Set_Title (Col_Piece_Image, "Piece");
      C := Gtk.Tree_View.Append_Column (P_Wnd_Action.all.Performing_Pieces_Tree_View, Col_Piece_Image);
      ...
      C := Gtk.Tree_View.Append_Column (P_Wnd_Action.all.Performing_Pieces_Tree_View, Col_Piece_Name);
      ...
      Gtk.Tree_View.Set_Activate_On_Single_Click (P_Wnd_Action.all.Performing_Pieces_Tree_View, True);
      Gtk.Box.Pack_Start
        (P_Wnd_Action.all.Performing_Pieces_Scroll_VBox, P_Wnd_Action.all.Performing_Pieces_Tree_View);
      Gtk.Tree_View.Set_Size_Request (P_Wnd_Action.all.Performing_Pieces_Tree_View, 150, 200);

      Callbacks_Tubastga.Tree_View_Cb.Connect
        (P_Wnd_Action.all.Performing_Pieces_Tree_View, "row-activated",
   ...
   procedure Initialize_Performing_Piece_Effects_Scroll_VBox
     (P_Wnd_Action : access Type_Wnd_Action_Record'Class)
   is
      Piece_Info : Glib.GType_Array (1 .. 3) :=
        Glib.GType_Array'(1 => Glib.GType_Int, 2 => Gdk.Pixbuf.Get_Type, 3 => Glib.GType_String);
      ...
      C               : Glib.Gint;
   begin
      P_Wnd_Action.all.Performing_Piece_Effects_Scroll_VBox :=
      ...
      Gtk.Tree_View.Gtk_New
        (P_Wnd_Action.all.Performing_Piece_Effects_Tree_View,
         P_Wnd_Action.all.Performing_Piece_Effects_List_Store);

      Gtk.Tree_View_Column.Gtk_New (Col_Piece_Image);
      Gtk.Tree_View_Column.Set_Title (Col_Piece_Image, "Effect");
      C :=
        Gtk.Tree_View.Append_Column
          (P_Wnd_Action.all.Performing_Piece_Effects_Tree_View, Col_Piece_Image);
      Gtk.Cell_Renderer_Pixbuf.Gtk_New (Pixbuf_Renderer);
      Gtk.Tree_View_Column.Pack_Start (Col_Piece_Image, Pixbuf_Renderer, True);
      Gtk.Tree_View_Column.Add_Attribute (Col_Piece_Image, Pixbuf_Renderer, "pixbuf", 1);
      ...
      C :=
        Gtk.Tree_View.Append_Column
          (P_Wnd_Action.all.Performing_Piece_Effects_Tree_View, Col_Piece_Name);
      Gtk.Cell_Renderer_Text.Gtk_New (Text_Renderer);
      Gtk.Tree_View_Column.Pack_Start (Col_Piece_Name, Text_Renderer, True);
      Gtk.Tree_View_Column.Add_Attribute (Col_Piece_Name, Text_Renderer, "text", 2);

      Gtk.Tree_View.Set_Activate_On_Single_Click
        (P_Wnd_Action.all.Performing_Piece_Effects_Tree_View, True);
      Gtk.Box.Pack_Start
        (P_Wnd_Action.all.Performing_Piece_Effects_Scroll_VBox,
         P_Wnd_Action.all.Performing_Piece_Effects_Tree_View);
      Gtk.Tree_View.Set_Size_Request (P_Wnd_Action.all.Performing_Piece_Effects_Tree_View, 150, 200);

      Callbacks_Tubastga.Tree_View_Cb.Connect
        (P_Wnd_Action.all.Performing_Piece_Effects_Tree_View, "row-activated",
         Callbacks_Tubastga.Tree_View_Cb.To_Marshaller
           (Tubastga_Window_Pkg.Callbacks.Actions_Menu.On_Performing_Patch_Piece_Effects_Tree_View'
              Access),
         False);
   ...
   begin
      P_Wnd_Action.all.Target_Pieces_Scroll_VBox := Gtk.Box.Gtk_Vbox_New (True, Glib.Gint (2));
      ...
      Gtk.Box.Pack_Start
        (P_Wnd_Action.all.Target_Pieces_Scroll_VBox, P_Wnd_Action.all.Target_Pieces_Tree_View);
   ...
   --Target_Piece_Effects_Scroll_VBox
   procedure Initialize_Target_Piece_Effects_Scroll_VBox
     (P_Wnd_Action : access Type_Wnd_Action_Record'Class)
   is
      Piece_Info : Glib.GType_Array (1 .. 3) :=
        Glib.GType_Array'(1 => Glib.GType_Int, 2 => Gdk.Pixbuf.Get_Type, 3 => Glib.GType_String);
      ...
      C               : Glib.Gint;
   begin
      P_Wnd_Action.all.Target_Piece_Effects_Scroll_VBox :=
        Gtk.Box.Gtk_Vbox_New (True, Glib.Gint (2));

      Gtk.List_Store.Gtk_New (P_Wnd_Action.all.Target_Piece_Effects_List_Store, Piece_Info);
      Gtk.Tree_View.Gtk_New
        (P_Wnd_Action.all.Target_Piece_Effects_Tree_View,
         P_Wnd_Action.all.Target_Piece_Effects_List_Store);

      Gtk.Tree_View_Column.Gtk_New (Col_Piece_Image);
      Gtk.Tree_View_Column.Set_Title (Col_Piece_Image, "Effect");
      C :=
        Gtk.Tree_View.Append_Column
          (P_Wnd_Action.all.Target_Piece_Effects_Tree_View, Col_Piece_Image);
      Gtk.Cell_Renderer_Pixbuf.Gtk_New (Pixbuf_Renderer);
      Gtk.Tree_View_Column.Pack_Start (Col_Piece_Image, Pixbuf_Renderer, True);
      Gtk.Tree_View_Column.Add_Attribute (Col_Piece_Image, Pixbuf_Renderer, "pixbuf", 1);
      ...
      C :=
        Gtk.Tree_View.Append_Column
          (P_Wnd_Action.all.Target_Piece_Effects_Tree_View, Col_Piece_Name);
      Gtk.Cell_Renderer_Text.Gtk_New (Text_Renderer);
      Gtk.Tree_View_Column.Pack_Start (Col_Piece_Name, Text_Renderer, True);
      Gtk.Tree_View_Column.Add_Attribute (Col_Piece_Name, Text_Renderer, "text", 2);

      Gtk.Tree_View.Set_Activate_On_Single_Click
        (P_Wnd_Action.all.Target_Piece_Effects_Tree_View, True);
      Gtk.Box.Pack_Start
        (P_Wnd_Action.all.Target_Piece_Effects_Scroll_VBox,
         P_Wnd_Action.all.Target_Piece_Effects_Tree_View);
      Gtk.Tree_View.Set_Size_Request (P_Wnd_Action.all.Target_Piece_Effects_Tree_View, 150, 200);

      Callbacks_Tubastga.Tree_View_Cb.Connect
        (P_Wnd_Action.all.Target_Piece_Effects_Tree_View, "row-activated",
         Callbacks_Tubastga.Tree_View_Cb.To_Marshaller
           (Tubastga_Window_Pkg.Callbacks.Actions_Menu.On_Target_Patch_Piece_Effects_Tree_View'
              Access),
         False);

   end Initialize_Target_Piece_Effects_Scroll_VBox;
   ...
   begin
      ...
      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Attack);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Attack, "Attack");

      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Ranged_Attack);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Ranged_Attack, "Range Attack");

      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Search);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Search, "Search");
...
--        --
      ...
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Create_Path, "Create Path");
      Gtk.Button.Set_Image
        (P_Wnd_Action.all.Btn_Create_Path,
         Gtk.Image.Gtk_Image_New_From_File ("resources\demote.png"));

      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Remove_Path);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Remove_Path, "Remove Path");
      Gtk.Button.Set_Image
        (P_Wnd_Action.all.Btn_Create_Path,
         Gtk.Image.Gtk_Image_New_From_File ("resources\demote.png"));
   ...
   begin
      ...
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Place_Wall1, "Place Wall 1");
      Gtk.Button.Set_Image
        (P_Wnd_Action.all.Btn_Place_Wall1,
         Gtk.Image.Gtk_Image_New_From_File ("resources\button_wall1.png"));

      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Place_Wall2);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Place_Wall2, "Place Wall 2");
      Gtk.Button.Set_Image
      ...
      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Place_Wall3);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Place_Wall3, "Place Wall 3");
      Gtk.Button.Set_Image
        (P_Wnd_Action.all.Btn_Place_Wall3,
         Gtk.Image.Gtk_Image_New_From_File ("resources\button_wall3.png"));

      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Place_Wall4);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Place_Wall4, "Place Wall 4");
      Gtk.Button.Set_Image
        (P_Wnd_Action.all.Btn_Place_Wall4,
         Gtk.Image.Gtk_Image_New_From_File ("resources\button_wall4.png"));

      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Place_Wall5);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Place_Wall5, "Place Wall 5");
      Gtk.Button.Set_Image
        (P_Wnd_Action.all.Btn_Place_Wall5,
         Gtk.Image.Gtk_Image_New_From_File ("resources\button_wall5.png"));

      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Place_Wall6);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Place_Wall6, "Place Wall 6");
      Gtk.Button.Set_Image
   ...
   begin
      ...
      ---
      -- Remove WallN
      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Remove_Wall1);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Remove_Wall1, "Remove Wall 1");
      Gtk.Button.Set_Image
        (P_Wnd_Action.all.Btn_Remove_Wall1,
         Gtk.Image.Gtk_Image_New_From_File ("resources\button_wall1.png"));

      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Remove_Wall2);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Remove_Wall2, "Remove Wall 2");
      Gtk.Button.Set_Image
      ...
      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Remove_Wall3);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Remove_Wall3, "Remove Wall 3");
      Gtk.Button.Set_Image
        (P_Wnd_Action.all.Btn_Remove_Wall3,
         Gtk.Image.Gtk_Image_New_From_File ("resources\button_wall3.png"));

      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Remove_Wall4);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Remove_Wall4, "Remove Wall 4");
      Gtk.Button.Set_Image
        (P_Wnd_Action.all.Btn_Remove_Wall4,
         Gtk.Image.Gtk_Image_New_From_File ("resources\button_wall4.png"));

      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Remove_Wall5);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Remove_Wall5, "Remove Wall 5");
      Gtk.Button.Set_Image
        (P_Wnd_Action.all.Btn_Remove_Wall5,
         Gtk.Image.Gtk_Image_New_From_File ("resources\button_wall5.png"));

      Gtk.Button.Gtk_New (P_Wnd_Action.all.Btn_Remove_Wall6);
      Gtk.Button.Set_Label (P_Wnd_Action.all.Btn_Remove_Wall6, "Remove Wall 6");
      Gtk.Button.Set_Image
   ...
   begin
      ...
      Initialize_Target_Piece_Effects_Scroll_VBox (P_Wnd_Action);
      ...
      P_Wnd_Action.all.Target_Content_HBox := Gtk.Box.Gtk_Hbox_New (True, Glib.Gint (2));

      Gtk.Box.Pack_Start
        (P_Wnd_Action.all.Target_Content_HBox, P_Wnd_Action.all.Target_Pieces_Scroll_VBox);
      Gtk.Box.Pack_Start
        (P_Wnd_Action.all.Target_Content_HBox, P_Wnd_Action.all.Target_Piece_Effects_Scroll_VBox);
      Gtk.Box.Pack_Start (P_Wnd_Action.all.Content_HBox, P_Wnd_Action.all.Target_Content_HBox);
