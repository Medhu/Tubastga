...
package body Tubastga_Piece.Server_Logic.Carrier is
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Get_Tower_Code - enter " & P_Tower_Id1'Img & "-" & P_Tower_Id2'Img & "-" & P_Tower_Id3'Img & "-");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Get_Tower_Code - exit Tmp=" & Tmp);
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Get_Tower_Id - enter P_Tower_Code=" & P_Tower_Code'Img);
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Get_Tower_Id - enter Ret=" & Ret'Img);
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Get_Tower_Goods_Code - enter P_Goods_Id1=" & P_Goods_Id1'Img & " P_Goods_Id2=" & P_Goods_Id2'Img & " P_Goods_Id3=" & P_Goods_Id3'Img);
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Get_Tower_Goods_Code - enter Tmp=" & Tmp);
      end if;
      return Integer'Value (Tmp);
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Carrier_Tower_Stops - enter");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Tubastga_Piece.Server_Logic.Carrier.Carrier_Tower_Stops - exit To_Tower_Id=" & To_Tower_Id'Img);
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Carrier_Tower_Load - enter");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Tubastga_Piece.Server_Logic.Carrier.Carrier_Tower_Load - exit To_Goods_Id=" & To_Goods_Id'Img);
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Carrier_Tower_Unload - enter P_Tower_Number=" & P_Tower_Number'Img);
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Carrier_Tower_Unload - exit To_Goods_Id=" & To_Goods_Id'Img);
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Carrier_Move- enter");
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line
           ("Tubastga_Piece.Carrier_Tower_Transaction - enter Tower.Piece_Id=" & P_Tower.Id'Img);
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Carrier_Tower_Transaction - exit");
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Get_Path_Patches- enter");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Get_Path_Patches- exit");
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Get_Remove_Path_From_Carrier- enter");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Tubastga_Piece.Server_Logic.Carrier.Get_Remove_Path_From_Carrier- exit Piece_Id=" & Piece_Id'Img);
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Create_From_Path_Patch_List- enter");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Create_From_Path_Patch_List- exit");
      end if;
      return The_Path;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Clear_Path_Effects- enter");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Clear_Path_Effects- exit");
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Create_Workers_Path- enter");
      end if;

      A_Patch_List := Tubastga_Piece.Server_Logic.Carrier.Get_Create_Path_Patches (P_Player_Id);

      if A_Patch_List.Piece_Id /= Piece.Undefined_Piece_Id then
         New_Path :=
           Tubastga_Piece.Server_Logic.Carrier.Create_From_Path_Patch_List
             (P_Player_Id,
         ...
         Tubastga_Piece.Server_Logic.Carrier.Clear_Path_Effects (P_Player_Id);
      end if;

      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Create_Workers_Path- exit");
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Remove_Workers_Path- enter");
      end if;

      Remove_Piece_Id := Tubastga_Piece.Server_Logic.Carrier.Get_Remove_Path_From_Carrier (P_Player_Id);
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.Carrier.Remove_Workers_Path- exit");
      end if;
   end Remove_Workers_Path;

end Tubastga_Piece.Server_Logic.Carrier;
