...
package body Tubastga_Piece.Server_Logic.House_Piece is
   ...
   begin
      if Verbose then
         Text_IO.Put_Line
           ("Tubastga_Piece.Server_Logic.House_Piece.Count_Patches_With_Production - enter");
      end if;
      ...
      if Verbose then
         Text_IO.Put_Line
           ("Tubastga_Piece.Server_Logic.House_Piece.Count_Patches_With_Production - exit Ret=" &
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.House_Piece.Farm_House_Production - enter");
      end if;

      A_House_Id := Tubastga_Piece.Server_Logic.House_Piece.Find_Tower_In_Radius (P_Patch.Pos, 4);
      ...
      if A_House_Id /= Piece.Undefined_Piece_Id then
         ...
         Count_Producing_Patches :=
           Count_Patches_With_Production
             (P_Patch.Pos,
              Tubastga_Piece.Landscape_Grass,
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.House_Piece.Farm_House_Production - exit");
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.House_Piece.Lumberjack_House_Production - enter");
      end if;
      ...
      if A_House_Id /= Piece.Undefined_Piece_Id then
         ...
         Count_Producing_Patches :=
           Count_Patches_With_Production
             (P_Patch.Pos,
              Tubastga_Piece.Landscape_Forest,
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.House_Piece.Lumberjack_House_Production - exit");
      end if;
   ...
   begin
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.House_Piece.Stonecutter_House_Production - enter");
      end if;
      ...
      if A_House_Id /= Piece.Undefined_Piece_Id then
         ...
         Count_Producing_Patches :=
           Count_Patches_With_Production
             (P_Patch.Pos,
              Tubastga_Piece.Landscape_Mountain,
      ...
      if Verbose then
         Text_IO.Put_Line ("Tubastga_Piece.Server_Logic.House_Piece.Stonecutter_House_Production - exit");
      end if;
