...
procedure Tubastga_Window is
   Tubastga_Window : Wnd_Main_Access;
...
begin
   ...
   Gtk.Main.Init;
   Id1 := Glib.Main.Idle_Add (Tubastga_Window_Pkg.Callbacks.Periodic_Updates_Summary'Access);

   Gtk_New (Tubastga_Window);
   Show_All (Tubastga_Window);

   Gtk_New (Tubastga_Window.all.dlgMainMenu);
