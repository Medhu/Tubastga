...
package Tubastga_Window_Pkg is
   ...
   type Type_Dlg_Main_Menu_Record is new Gtk.Dialog.Gtk_Dialog_Record with record
      ...
      Btn_Connect_Server, Btn_Refresh, Btn_Create_Game, Btn_Save_Game, Btn_Load_Game, Btn_Join_Game,
      Btn_Leave_Game, Btn_Disconnect_Server, Btn_Close : Gtk.Button.Gtk_Button;
      --
      Box_Connect                : Gtk.Box.Gtk_Hbox;
      TCPIPLabel, TCPIPPortLabel : Gtk.Label.Gtk_Label;
      Adj_TCPIPOctet1, Adj_TCPIPOctet2, Adj_TCPIPOctet3, Adj_TCPIPOctet4,
      Adj_TCPIPPort : Gtk.Adjustment.Gtk_Adjustment;
      Spn_TCPIPOctet1, Spn_TCPIPOctet2, Spn_TCPIPOctet3, Spn_TCPIPOctet4,
      Spn_TCPIPPort : Gtk.Spin_Button.Gtk_Spin_Button;
      --
      Box_Create_Game : Gtk.Box.Gtk_Hbox;
      Lbl_Create_Game_Player_Name_1, Lbl_Create_Game_Player_Name_2,
      Lbl_Create_Game_Player_Name_3 : Gtk.Label.Gtk_Label;
      En_Create_Game_Player_Name_1, En_Create_Game_Player_Name_2,
   ...
   package Performing_Piece_Pkg is new Ada.Containers.Vectors (Positive,
      Type_HBox_Performing_Piece);
   --
   type Type_Wnd_Action_Record is new Gtk.Window.Gtk_Window_Record with record
      ...
      -- Production Center
      Btn_Place_Wall1, Btn_Place_Wall2, Btn_Place_Wall3, Btn_Place_Wall4, Btn_Place_Wall5,
      Btn_Place_Wall6,
      --
      ...
      Target_Pieces_Scroll_VBox : Gtk.Box.Gtk_Vbox;

      Target_Pieces_List_Store : Gtk.List_Store.Gtk_List_Store;
      Target_Pieces_Tree_View  : Gtk.Tree_View.Gtk_Tree_View;

      Target_Piece_Effects_Scroll_VBox : Gtk.Box.Gtk_Vbox;
      Target_Piece_Effects_List_Store  : Gtk.List_Store.Gtk_List_Store;
      Target_Piece_Effects_Tree_View   : Gtk.Tree_View.Gtk_Tree_View;
   ...
   type Type_Wnd_Main_Record is new Gtk.Window.Gtk_Window_Record with record
      ...
      Area_Player_1_Timer, Area_Player_2_Timer,
      Area_Player_3_Timer                                     : Gtk.Drawing_Area.Gtk_Drawing_Area;
